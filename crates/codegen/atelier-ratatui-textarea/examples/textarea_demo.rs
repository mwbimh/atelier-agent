...
//!
//! Run with: cargo run -p atelier-ratatui-textarea --example textarea_demo
//!
...
use atelier_ratatui_textarea::wrapping::{RtOptions, word_wrap_line};
use atelier_ratatui_textarea::{
