...
/// Claude.md / `.atelier/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.atelier` and compat dirs.
...
/// Mirrors the serde shape of `atelier-agent`'s `AgentConfigFile`.
