...
// its wire types live in `atelier_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use atelier_workspace_types::rpc::fs::FsReadEncoding;
...
pub use atelier_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
