//! AcpFsAdapter: implements `atelier-tools::AsyncFileSystem` using ACP gateway calls.
//!
//! This adapter enables file tool execution over ACP (remote filesystem).
//! It translates atelier-tools' `AsyncFileSystem` trait into ACP protocol calls:
