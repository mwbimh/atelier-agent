...
/// Payload for the `atelier/git_head_changed` ACP extension notification.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
///
/// 1. `supplied_cwd` is a atelier-managed worktree (`~/.atelier/worktrees/...`).
...
pub fn restore_code_checkout_allowed(supplied_cwd: &Path, persisted_cwd: Option<&str>) -> bool {
    let worktrees_dir = atelier_tools::util::atelier_home::atelier_home().join("worktrees");
...
const REWIND_GIT_ENV: &str = "ATELIER_WORKSPACE_REWIND_GIT";
...
pub fn git_rewind_enabled() -> bool {
    atelier_config::env_bool(REWIND_GIT_ENV).unwrap_or(false)
}
...
mod tests {
    ...
    fn test_effective_worktree_cwd_empty_offset() {
        let result =
            effective_worktree_cwd("/home/user/.atelier/worktrees/repo/ab-123-a", Path::new(""));
        assert_eq!(result, "/home/user/.atelier/worktrees/repo/ab-123-a");
    }
    #[test]
    ...
    fn test_effective_worktree_cwd_nested_offset() {
        let result = effective_worktree_cwd(
            "/home/user/.atelier/worktrees/repo/ab-123-b",
...
mod restore_code_tests {
    ...
    async fn stash_before_destructive_op_dirty_tracked_returns_ref() {
        ...
        assert!(
            list.contains("atelier: pre-test sess-2"),
    ...
    fn restore_code_checkout_allowed_worktree_cwd_is_allowed() {
        let worktrees = Path::new("/home/u/.atelier/worktrees");
        assert!(restore_code_checkout_allowed_in(
            Path::new("/home/u/.atelier/worktrees/home-u-repo/2026-05-22-9f2e51ce"),
            Some("/home/u/repo"),
            worktrees,
        ));
    }
    ...
    fn restore_code_checkout_allowed_source_repo_with_worktree_session_is_refused() {
        ...
        assert!(!restore_code_checkout_allowed_in(
            Path::new("/home/u/repo"),
            Some("/home/u/.atelier/worktrees/home-u-repo/2026-05-22-9f2e51ce"),
            worktrees,
        ));
    }
    #[test]
