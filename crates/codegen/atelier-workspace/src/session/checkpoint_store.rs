...
//!
//! ```text
//! <cwd>/.atelier/rewind-checkpoints/
...
/// Directory (under `<cwd>/.atelier`) holding every session's checkpoint store.
...
pub(crate) struct CheckpointStore {
    /// Per-session store directory: `<cwd>/.atelier/rewind-checkpoints/<session_id>`.
    dir: PathBuf,
