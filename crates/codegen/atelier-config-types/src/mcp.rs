//! MCP server configuration value types, extracted from atelier-shell
//! (config dependency inversion).

use agent_client_protocol as acp;
use atelier_mcp::oauth_config::McpOAuthConfig;
...
impl RelaySyncConfig {
    ...
    pub fn is_enabled(&self) -> bool {
        if let Ok(env_val) = std::env::var("ATELIER_RELAY_SYNC_ENABLED") {
