//! # atelier-hooks
//!
//! Runtime hook system for Atelier — file-based discovery, command execution,
//! and policy enforcement.
//!
//! ## Overview
//!
//! This crate provides a minimal hooks system for Atelier. Hooks are discovered
//! from dedicated directories (`~/.atelier/hooks/` and `<git-worktree-root>/.atelier/hooks/`),
...
//!     Some(Path::new("/home/user/.atelier/hooks")),
//!     Some(Path::new("/project/.atelier/hooks")),
//! );
//!
//! for err in &errors {
