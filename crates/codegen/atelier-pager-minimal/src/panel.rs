...
use atelier_pager::views::extensions_modal::{ExtensionsTab, TabDataState};
use atelier_pager::views::modal::ActiveModal;
use atelier_pager::views::picker::{self, PickerEntry, PickerField, PickerHitAreas, PickerRow};
...
mod tests {
    use super::*;
    use atelier_pager::views::extensions_modal::ExtensionsModalState;
    use atelier_pager::views::mcps_modal::{McpServerDisplayStatus, McpServerInfo, McpWireSource};
    use ratatui::layout::Rect;
    ...
    fn session_entry(id: &str) -> atelier_pager::app::app_view::SessionPickerEntry {
        atelier_pager::app::app_view::SessionPickerEntry {
            id: id.into(),
            summary: id.into(),
    ...
    fn with_resume(entries: Vec<atelier_pager::app::app_view::SessionPickerEntry>) -> AgentView {
        let mut a = agent();
        a.active_modal = Some(ActiveModal::SessionPicker {
            ...
            window: atelier_pager::views::modal_window::ModalWindowState::new(),
            content_results: None,
            content_loading: false,
            deep_search_seq: 0,
            source_filter: atelier_pager::views::session_picker::SourceFilter::default(),
            pending_delete: None,
            entries_query: None,
        });
        a
