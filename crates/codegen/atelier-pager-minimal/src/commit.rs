...
use atelier_pager::appearance::AppearanceConfig;
use atelier_pager::minimal_api;
use atelier_pager::render::Renderable;
use atelier_pager::scrollback::block::RenderBlock;
use atelier_pager::scrollback::blocks::ToolCallBlock;
use atelier_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                atelier_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
