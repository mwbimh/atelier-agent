...
use atelier_shell::tools::TodoStatus;
    ...
    let mut lines: Vec<Line<'static>> = todos
        ...
        .map(|t| {
            let (glyph, style) = match t.status {
                ...
                TodoStatus::Completed => (atelier_pager::glyphs::check_mark(), theme.muted()),
                TodoStatus::Cancelled => (
                    atelier_pager::glyphs::ballot_x(),
...
mod tests {
    ...
    use atelier_shell::tools::{TodoItem, TodoPriority};
