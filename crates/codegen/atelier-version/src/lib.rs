//! Installed atelier CLI version, lockstepped with shipping binaries.

use semver::Version;

pub const TEST_VERSION_ENV: &str = "ATELIER_TEST_VERSION";

pub const VERSION: &str = match option_env!("ATELIER_VERSION") {
    Some(v) => v,
