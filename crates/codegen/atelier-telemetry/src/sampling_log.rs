//! Tracing layer for `target: "sampling_log"` → `~/.atelier/logs/sampling.jsonl`.
//! Enable with `--log-sampling` or `ATELIER_LOG_SAMPLING=1`.
...
const ENV_VAR: &str = "ATELIER_LOG_SAMPLING";
