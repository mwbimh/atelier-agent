//! atelier-hunk-tracker - Track file hunks (diffs) with agent/external attribution.
//!
//! This crate provides:
//! - Actor-based hunk tracking with source attribution (Agent vs External)
//! - Integration with atelier-shell sessions
//!
//! ## Actor Pattern
//!
...
//!
//! ```rust,ignore
//! use atelier_hunk_tracker::{HunkTrackerActor, HunkEvent, TrackingMode, HunkAction};
//! use tokio::sync::mpsc;
//!
