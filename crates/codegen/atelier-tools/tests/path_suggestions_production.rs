...
//! Run:
//! ```bash
//! cargo test -p atelier-tools --test path_suggestions_production
//! ```

use atelier_tools::util::path_suggestions::{format_not_found_error, path_not_found_hint};
...
fn similar_names(hint: &atelier_tools::util::path_suggestions::PathNotFoundHint) -> Vec<String> {
    hint.similar
        .iter()
...
#[tokio::test]
async fn pattern2_atelier_sessions_internal_path() {
