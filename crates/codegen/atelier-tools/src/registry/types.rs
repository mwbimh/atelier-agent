use crate::{
    ...
    implementations::{
        atelier_build, atelier_build_concise, atelier_build_hashline, codex, opencode,
...
/// this crate: instead of `atelier-tools` referencing an out-of-tree tool
/// pack, the pack calls
...
pub struct SessionContext {
    ...
    pub parent_scheduler_handle:
        Option<crate::implementations::atelier_build::scheduler::types::SchedulerHandle>,
    ...
    pub web_fetch_config: crate::implementations::atelier_build::web_fetch::WebFetchConfig,
    ...
    pub video_gen_config: crate::implementations::atelier_build::video_gen::VideoGenConfig,
    ...
    pub app_builder_deployer_config:
        crate::implementations::atelier_build::deploy_app::AppBuilderDeployerConfig,
...
impl ToolRegistryBuilder {
    ...
    /// Fully-qualified tool id (`"AtelierBuild:read_file"`) → declared
    ...
    pub fn new() -> Self {
        ...
        b.register_with_params::<atelier_build::BashTool, atelier_build::bash::BashParams>();
        b.register_with_params::<atelier_build::ReadFileTool, atelier_build::read_file::ReadFileParams>();
        b.register_with_params::<
                atelier_build::SearchReplaceTool,
                atelier_build::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<atelier_build::ListDirTool, atelier_build::list_dir::ListDirParams>();
        b.register_with_params::<atelier_build::GrepTool, atelier_build::grep::GrepParams>();
        b.register::<atelier_build::KillTaskTool>();
        b.register::<atelier_build::KillTerminalCommandTool>();
        b.register::<atelier_build::TodoWriteTool>();
        b.register::<atelier_build::UpdateGoalTool>();
        b.register::<atelier_build::TaskOutputTool>();
        b.register::<atelier_build::GetTerminalCommandOutputTool>();
        b.register::<atelier_build::WaitTasksTool>();
        ...
        b.register_with_params::<
                atelier_build::AskUserQuestionTool,
                atelier_build::ask_user_question::AskUserQuestionParams,
            >();
        b.register::<atelier_build::MonitorTool>();
        b.register::<atelier_build::SchedulerCreateTool>();
        b.register::<atelier_build::SchedulerDeleteTool>();
        b.register::<atelier_build::SchedulerListTool>();
        ...
        b.register_with_params::<
            ...
            >();
        b.register_with_params::<
                atelier_build_concise::ReadFileConciseTool,
                atelier_build::read_file::ReadFileParams,
            >();
        b.register_with_params::<
                atelier_build_concise::SearchReplaceConciseTool,
                atelier_build::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<
                atelier_build_concise::BashConciseTool,
                atelier_build::bash::BashParams,
            >();
        b.register_with_params::<
                atelier_build_hashline::HashlineReadTool,
                atelier_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                atelier_build_hashline::HashlineEditTool,
                atelier_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                atelier_build_hashline::HashlineGrepTool,
                atelier_build_hashline::config::HashlineSchemeParams,
            >();
    ...
    pub fn validate_config(&self, config: &ToolServerConfig) -> Vec<RequirementError> {
        ...
        }
        {
            ...
            let hashline_file_ids: &[&str] = &[
                ...
                "AtelierBuildHashline:hashline_grep",
            ];
    ...
    pub fn finalize_with_trunc_config(
        ...
        {
            match crate::implementations::atelier_build::web_fetch::WebFetchClient::new(params) {
                Ok(client) => {
                    resources.insert(client);
                }
                Err(e) => {
        ...
        resources.register_state::<crate::implementations::atelier_build::todo::TodoState>();
        ...
        resources
            ...
            >();
        resources
            .register_state::<crate::implementations::atelier_build::scheduler::types::SchedulerState>(
            );
        ...
        let (scheduler_cmd_rx, scheduler_cancel_token) =
            if let Some(parent_handle) = ctx.parent_scheduler_handle {
                ...
                resources.insert(
                    crate::implementations::atelier_build::scheduler::types::SchedulerHandle(
                        scheduler_cmd_tx,
                    ),
                );
        ...
        if let (Some(cmd_rx), Some(cancel_token)) = (scheduler_cmd_rx, &scheduler_cancel_token) {
            let actor = crate::implementations::atelier_build::scheduler::actor::SchedulerActor {
...
impl FinalizedToolset {
    ...
    /// `atelier/*` tool `_meta` contract (tool normalization). Returns `None` for
...
fn explain_requirement_failure(
    ...
    match fq_tool_id.as_str() {
        ...
        "AtelierBuild:get_task_output" => {
            let has_atelier_build_bash = has_tool_with_bool_param(
                proposed,
                "AtelierBuild",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_atelier_build_concise_bash = has_tool_with_bool_param(
                proposed,
                "AtelierBuildConcise",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_task = has_tool(proposed, "AtelierBuild", "task");
            let mut notes = vec![];
            if has_tool(proposed, "AtelierBuild", "run_terminal_cmd")
                && !has_atelier_build_bash
            {
                notes
                    .push(
                        "AtelierBuild:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            if has_tool(proposed, "AtelierBuildConcise", "run_terminal_cmd")
                && !has_atelier_build_concise_bash
            {
                notes
                    .push(
                        "AtelierBuildConcise:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            let mut message = "get_task_output requires a background-capable bash tool (AtelierBuild:run_terminal_cmd or AtelierBuildConcise:run_terminal_cmd with enabled_background=true), OpenCode:bash, or AtelierBuild:task"
                .to_string();
            let has_provider = has_atelier_build_bash || has_atelier_build_concise_bash
            ...
            RequirementError::new(fq_tool_id, message)
                .with_field_path("tools")
                .with_expected(
                    "include a background-capable bash tool, OpenCode:bash, or AtelierBuild:task",
                )
                .with_category("requirements")
        }
        "AtelierBuild:search_replace" if !params
            ...
            RequirementError::new(
                ...
                .with_expected(
                    "set skip_read_before_edit=true or include a Read tool such as AtelierBuild:read_file",
                )
                .with_bad_value(serde_json::Value::Bool(false))
                .with_category("requirements")
        }
        "AtelierBuild:enter_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "enter_plan_mode requires AtelierBuild:exit_plan_mode so plan mode can always be exited",
                )
                .with_field_path("tools")
                .with_expected("include AtelierBuild:exit_plan_mode")
                .with_category("requirements")
        }
        "AtelierBuild:exit_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "exit_plan_mode requires AtelierBuild:enter_plan_mode so plan mode can be entered before exiting",
                )
                .with_field_path("tools")
                .with_expected("include AtelierBuild:enter_plan_mode")
                .with_category("requirements")
        }
        _ => {
...
mod tests {
    ...
    fn test_session_context(tmp: &TempDir) -> SessionContext {
        SessionContext {
            ...
            web_fetch_config:
                crate::implementations::atelier_build::web_fetch::WebFetchConfig::default(),
            lsp: None,
            image_gen_config:
            ...
            app_builder_deployer_config:
                crate::implementations::atelier_build::deploy_app::AppBuilderDeployerConfig::default(
                ),
    ...
    /// appeared before `atelier_build:search_replace` (`ToolKind::Edit`, input:
    ...
    async fn kind_params_merged_across_multiple_tools_of_same_kind() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "AtelierBuild:search_replace".to_string(),
                    params: Some(
                        serde_json::json!({
    ...
    async fn search_replace_description_renders_minimum_anchor_guidance() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "AtelierBuild:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    /// Smoke test: finalize the full AtelierBuild toolset and verify every
    ...
    async fn full_toolset_descriptions_render_cleanly() {
        ...
        let config = ToolServerConfig {
            ...
            .into_iter()
            .map(|id| ToolConfig::from_id(format!("AtelierBuild:{id}")))
            .collect(),
            behavior_preset: None,
        };
        let tmp = TempDir::new().unwrap();
    ...
    /// name: `run_terminal_cmd` (atelier).
    #[tokio::test]
    async fn tool_name_for_kind_resolves_execute() {
        use crate::types::tool::ToolKind;
        let tmp = TempDir::new().unwrap();
        let atelier = ToolRegistryBuilder::new()
            .finalize(
                ToolServerConfig {
                    tools: vec![
                        ToolConfig::from_id("AtelierBuild:run_terminal_cmd".to_string()),
                        ToolConfig::from_id("AtelierBuild:get_task_output".to_string()),
                        ToolConfig::from_id("AtelierBuild:kill_task".to_string()),
                    ],
                    behavior_preset: None,
                },
                test_session_context(&tmp),
            )
            .expect("atelier toolset should finalize");
        assert_eq!(
            atelier.tool_name_for_kind(ToolKind::Execute).as_deref(),
            Some("run_terminal_cmd")
        );
    }
    /// `merge_tool_meta` (the harness emission path) must stamp `atelier/tool` for a
    ...
    fn tool_config_kind_sinks_unknown_to_other() {
        ...
        let known = parse(serde_json::json!({ "id" : "AtelierBuild:read_file", "kind" : "read" }));
        assert_eq!(known.kind, Some(ToolKind::Read));
        let typo = parse(serde_json::json!({ "id" : "AtelierBuild:read_file", "kind" : "raed" }));
        assert_eq!(typo.kind, Some(ToolKind::Other));
        let absent = parse(serde_json::json!({ "id" : "AtelierBuild:read_file" }));
    ...
    /// Verify AtelierBuildConcise tools can be finalized and produce concise output.
    #[tokio::test]
    async fn test_concise_namespace_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "AtelierBuildConcise:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "AtelierBuildConcise:search_replace".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "AtelierBuildConcise:run_terminal_cmd".to_string(),
                    params: Some(
                ...
                ToolConfig::for_tool::<atelier_build::GrepTool>(),
                ToolConfig::for_tool::<atelier_build::KillTaskTool>(),
                ToolConfig::for_tool::<atelier_build::TaskOutputTool>(),
                ToolConfig {
                    id: "AtelierBuild:list_dir".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    fn has_tool_id_knows_pinned_tool_config_ids() {
        let builder = ToolRegistryBuilder::new();
        for id in [
            "AtelierBuild:run_terminal_cmd",
            "AtelierBuild:read_file",
            "AtelierBuild:search_replace",
            "AtelierBuild:list_dir",
            "AtelierBuild:grep",
            "AtelierBuild:get_terminal_command_output",
            "AtelierBuild:kill_terminal_command",
        ] {
            assert!(
        ...
        assert!(
            !builder.has_tool_id("AtelierBuild:does_not_exist"),
    ...
    fn known_tool_kinds_maps_pinned_tool_config_ids() {
        ...
        for (id, expected) in [
            ("AtelierBuild:run_terminal_cmd", ToolKind::Execute),
            ("AtelierBuild:read_file", ToolKind::Read),
            ("AtelierBuild:search_replace", ToolKind::Edit),
            ("AtelierBuild:grep", ToolKind::Search),
            ("AtelierBuild:list_dir", ToolKind::List),
        ] {
            assert_eq!(
                kinds.get(id),
                Some(&expected),
        ...
        assert!(
            !kinds.contains_key("AtelierBuild:does_not_exist"),
    ...
    /// (e.g. `"read_file"`). If both `AtelierBuild:read_file` and
    ...
    fn validate_config_reports_param_field_path_and_value() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "AtelierBuild:run_terminal_cmd".to_string(),
                params: Some(
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "AtelierBuild:run_terminal_cmd");
        assert_eq!(
    ...
    fn validate_config_reports_semantic_hashline_param_error() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "AtelierBuildHashline:hashline_read".to_string(),
                params: Some(
    ...
    async fn call_non_streaming_stub_back_compat() {
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<atelier_build::ReadFileTool>()],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
        let toolset = Arc::new(builder.finalize(config, ctx).unwrap());
    ...
    async fn tool_definitions_builtins_only_hides_mcp_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<atelier_build::ReadFileTool>(),
                ToolConfig::for_tool::<atelier_build::GrepTool>(),
            ],
            behavior_preset: None,
        };
    ...
    fn task_tool_rejected_without_get_task_output_and_kill_task() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "AtelierBuild:task".to_string(),
                params: None,
                name_override: None,
                params_name_overrides: None,
                description_override: None,
        ...
        assert!(
            errors.iter().any(|e| e.tool == "AtelierBuild:task"
                && e.message.contains("AtelierBuild:get_task_output")
                && e.message.contains("AtelierBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_get_task_output() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "AtelierBuild:get_task_output".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        assert!(
            errors
                .iter()
                .any(|e| e.tool == "AtelierBuild:task"
                    && e.message.contains("AtelierBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_kill_task() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "AtelierBuild:kill_task".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    /// atelier-build agent config (all tools present) and that the new examples
    ...
    async fn background_param_templates_reference_real_schema_keys() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                tool("AtelierBuild:run_terminal_cmd"),
                tool("AtelierBuild:task"),
                tool("AtelierBuild:get_task_output"),
                tool("AtelierBuild:wait_tasks"),
                tool("AtelierBuild:kill_task"),
            ],
            behavior_preset: None,
        };
        let tmp = TempDir::new().unwrap();
    ...
    fn bash_with_enabled_background_reports_missing_task_tools() {
        ...
        assert!(error.message.contains("AtelierBuild:get_task_output"));
        assert!(error.message.contains("AtelierBuild:kill_task"));
        assert!(
            error
                .expected
                .as_deref()
    ...
    fn task_requirement_error_lists_missing_background_tools() {
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "AtelierBuild:task");
        assert!(error.message.contains("AtelierBuild:get_task_output"));
        assert!(error.message.contains("AtelierBuild:kill_task"));
    ...
    fn search_replace_requirement_error_mentions_read_tool() {
        ...
        let error = errors
            .iter()
            .find(|error| error.tool == "AtelierBuild:search_replace")
    ...
    fn ask_user_question_validates_standalone() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "AtelierBuild:ask_user_question".to_string(),
                params: None,
                name_override: None,
                params_name_overrides: None,
                description_override: None,
    ...
    async fn task_description_renders_with_default_agent_config() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "AtelierBuild:grep".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "AtelierBuild:web_search".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        let toolset = builder
            .finalize(config, ctx)
            .expect("finalize should succeed with default atelier-build tools");
        let defs = toolset.tool_definitions();
        let task_def = defs
            .iter()
    ...
    fn hashline_tools_registered_in_builder() {
        ...
        assert!(
            builder
                .tools
                .contains_key("AtelierBuildHashline:hashline_read"),
            "hashline_read should be registered"
        );
        assert!(
            builder
                .tools
                .contains_key("AtelierBuildHashline:hashline_edit"),
            "hashline_edit should be registered"
        );
        assert!(
            builder
                .tools
                .contains_key("AtelierBuildHashline:hashline_grep"),
    ...
    async fn hashline_config_finalizes_successfully() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("AtelierBuildHashline:hashline_read"),
                hashline_tool_config("AtelierBuildHashline:hashline_edit"),
                hashline_tool_config("AtelierBuildHashline:hashline_grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn standard_and_hashline_each_finalize_independently() {
        ...
        let standard_config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("AtelierBuild:read_file"),
                hashline_tool_config("AtelierBuild:search_replace"),
                hashline_tool_config("AtelierBuild:grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn empty_struct_schema_has_properties_and_required() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<atelier_build::EnterPlanModeTool>(),
                ToolConfig::for_tool::<atelier_build::ExitPlanModeTool>(),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn hashline_toolset_e2e_with_utilities() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "AtelierBuildHashline:hashline_read".to_owned(),
                    params: Some(
                ...
                ToolConfig::for_tool::<atelier_build_hashline::HashlineEditTool>(),
                ToolConfig::for_tool::<atelier_build_hashline::HashlineGrepTool>(),
                ToolConfig::for_tool::<atelier_build::ListDirTool>(),
            ],
            behavior_preset: None,
        };
        let errors = builder.validate_config(&config);
    ...
    fn bash_config_with_background() -> ToolConfig {
        ToolConfig {
            id: "AtelierBuild:run_terminal_cmd".to_owned(),
            params: Some(
                serde_json::json!({ "enabled_background" : true })
                    .as_object()
                    .unwrap()
    ...
    async fn atelier_build_bridge(tmp: &TempDir) -> crate::bridge::ToolBridge {
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<atelier_build::ListDirTool>(),
                ToolConfig::for_tool::<atelier_build::ReadFileTool>(),
                ToolConfig::for_tool::<atelier_build::SearchReplaceTool>(),
                bash_config_with_background(),
                ToolConfig::for_tool::<atelier_build::TaskOutputTool>(),
                ToolConfig::for_tool::<atelier_build::KillTaskTool>(),
                ToolConfig::for_tool::<atelier_build::GrepTool>(),
                ToolConfig::for_tool::<atelier_build::TodoWriteTool>(),
            ],
            behavior_preset: None,
        };
    ...
    async fn hub_dispatch_list_dir() {
        ...
        let bridge = atelier_build_bridge(&tmp).await;
        let result = bridge
            .call(
                "list_dir",
    ...
    async fn hub_dispatch_parity_list_dir() {
        ...
        let hub_bridge = atelier_build_bridge(&tmp).await;
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<atelier_build::ListDirTool>()],
            behavior_preset: None,
        };
