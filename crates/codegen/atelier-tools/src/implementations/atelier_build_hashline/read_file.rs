...
//!
//! Reuses the core file-reading logic from [`atelier_build::read_file::run_read_file`]
...
mod tests {
    ...
    use crate::implementations::atelier_build::read_file::{MAX_LINES_READ, ReadFileTool};
    ...
    /// file content independently of atelier_build `read_file`).
    #[tokio::test]
