...
impl atelier_tool_runtime::Tool for HashlineEditTool {
    type Args = HashlineEditInput;
    type Output = crate::types::output::SearchReplaceOutput;

    fn id(&self) -> atelier_tool_protocol::ToolId {
        atelier_tool_protocol::ToolId::new("hashline_edit").expect("valid tool id")
    }
    ...
    async fn run(
    ...
    ) -> Result<crate::types::output::SearchReplaceOutput, atelier_tool_runtime::ToolError> {
        ...
        let (cwd, display_cwd, fs, scheme, hints_enabled) = {
            ...
            let cwd = match ctx.extensions.get::<atelier_tool_runtime::Cwd>() {
...
mod tests {
    ...
    fn anchors_for(content: &str) -> Vec<String> {
        use crate::implementations::atelier_build_hashline::anchor::split_lines;
        use crate::implementations::atelier_build_hashline::edit::apply::anchor_suffix;
        use crate::implementations::atelier_build_hashline::scheme::{
    ...
    fn test_scheme() -> Box<dyn crate::implementations::atelier_build_hashline::scheme::AnchorScheme>
    {
        crate::implementations::atelier_build_hashline::config::HashlineSchemeParams::default()
            .build_scheme()
            .unwrap()
    }
