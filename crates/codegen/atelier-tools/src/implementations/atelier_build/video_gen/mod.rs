...
const XAI_VIDEO_BASE_MODEL: &str = "atelier-imagine-video";
const XAI_VIDEO_QUALITY_MODEL: &str = "atelier-imagine-video-1.5-preview";
...
const DEFAULT_ZDR_VIDEO_KEY_PREFIX: &str = "atelier-videos/";
...
pub struct VideoGenClient {
    ...
    /// and return the SuperAtelier upsell prose. See [`VideoGenClient::is_tier_restricted`].
...
impl VideoGenClient {
    ...
    /// SuperAtelier upsell instead of issuing a doomed request.
    ...
    pub async fn generate_with_images(
        ...
        return Err(xai_tool_runtime::ToolError::new(
            ...
            "vendor video generation is disabled in the private build",
        ));
...
pub enum VideoGenConfig {
    ...
    Enabled {
        ...
        /// at call time with the SuperAtelier upsell prose. Set by the host from
