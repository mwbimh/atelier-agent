...
use crate::implementations::atelier_build::read_file::{ReadFileInput, run_read_file};
...
impl atelier_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // AtelierBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::atelier_build::read_file::ReadFileTool;
