...
use crate::implementations::atelier_build::bash::{
...
impl atelier_tool_runtime::Tool for BashConciseTool {
    ...
    async fn run(
        ...
        let result = atelier_tool_runtime::Tool::run(&BashTool, ctx, input).await?;
...
mod tests {
    ...
    fn no_double_header_after_default_prebake() {
        ...
        bash.output_for_prompt =
            crate::implementations::atelier_build::bash::format_default_prompt(&bash);
