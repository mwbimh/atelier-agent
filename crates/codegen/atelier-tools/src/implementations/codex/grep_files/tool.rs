...
use crate::implementations::atelier_build::grep::ripgrep::rg_path;
...
///
/// Shares `ToolKind::Search` with the atelier-build `GrepTool`. These tools are
/// namespace-exclusive — consumers enable either `AtelierBuild` or `Codex` search,
