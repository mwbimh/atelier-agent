...
pub enum SkillScope {
    /// cwd/.atelier/skills (highest priority)
    Local = 0,
...
mod tests {
    ...
    fn extracts_skill_name() {
        assert_eq!(
            skill_name_from_path("/home/user/.atelier/skills/deploy/SKILL.md"),
            Some("deploy"),
        );
    }
    ...
    fn nested_path() {
        assert_eq!(
            skill_name_from_path("/repo/.atelier/skills/my-skill/SKILL.md"),
            Some("my-skill"),
        );
    }
