...
use crate::implementations::atelier_build::ask_user_question::AskUserQuestionInput;
...
pub enum ToolInput {
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::atelier_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::atelier_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::atelier_build::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::atelier_build::scheduler::list::SchedulerListInput),
