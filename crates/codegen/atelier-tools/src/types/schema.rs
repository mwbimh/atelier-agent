...
///
/// Use with `#[schemars(with = "AtelierIntegerSchema")]` on `Option<usize>` fields.
pub struct AtelierIntegerSchema;
impl schemars::JsonSchema for AtelierIntegerSchema {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "atelier_integer_schema".into()
    }
