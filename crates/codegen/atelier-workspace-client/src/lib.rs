...
//! `atelier-workspace`. Wire types live in
//! `atelier_workspace_types::rpc`; this crate adds the connected-state
...
use atelier_workspace_types::rpc::fs::{
...
use atelier_workspace_types::rpc::git::{
...
use atelier_workspace_types::rpc::hunks::{
...
use atelier_workspace_types::rpc::search::{
    ContentSearchData, ContentSearchRequest, FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq,
    FuzzyStatusReq,
};
use atelier_workspace_types::rpc::session::{
    BeginPromptReq, EndPromptReq, FileRewindResponse, RewindToReq,
};
use atelier_workspace_types::rpc::skills::{DiscoverPluginsReq, DiscoverSkillsReq, SkillInfo};
...
use atelier_workspace_types::rpc::worktree::{
...
use atelier_workspace_types::rpc::{RpcEnvelope, RpcError, WORKSPACE_RPC_TOOL_ID, WorkspaceRpc};
        ...
        async fn run(&self, _ctx: ToolCallContext, args: Self::Args) -> Result<RawOut, ToolError> {
            ...
            match args.method.as_str() {
                ...
                "workspace.discover_skills" => ok(serde_json::json!(
                    ...
                    "path" : "/workspace/.atelier/skills/my-skill/SKILL.md", "scope"
                    : "local", }]
                )),
