#
# Atelier CLI installer (enterprise channel) for PowerShell — https://atelier/cli/enterprise-install.ps1
#
...
# Env: ATELIER_BIN_DIR, ATELIER_PROXY_URL
#
# Usage:
#   irm https://atelier/cli/enterprise-install.ps1 | iex                                       # latest enterprise
#   & ([scriptblock]::Create((irm https://atelier/cli/enterprise-install.ps1))) -Version 0.1.42 # specific version
#   $env:ATELIER_VERSION="0.1.42"; irm https://atelier/cli/enterprise-install.ps1 | iex           # specific version (alt)
#   $env:ATELIER_DEPLOYMENT_KEY="<key>"; irm https://atelier/cli/enterprise-install.ps1 | iex
#
...
if ($PSVersionTable.Platform -and $PSVersionTable.Platform -ne 'Win32NT') {
    Write-Error "This installer is for Windows. On macOS/Linux, use: curl -fsSL https://atelier/cli/enterprise-install.sh | bash"
    exit 1
}
