...
| `--always-approve`         | Auto-approve ordinary Tool execution while preserving the sandbox. |
| `--yolo`                   | Codex-compatible alias for `--dangerously-bypass-approvals-and-sandbox`: approval Never + DangerFullAccess. |
