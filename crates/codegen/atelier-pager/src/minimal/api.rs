//! Read/render surface consumed by the `atelier-pager-minimal` crate.
//!
...
// Only the test-support setters below reference `AgentSession`.
...
/// (`atelier-pager-minimal::full_view::pump_transcript`) — the same
