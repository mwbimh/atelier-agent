...
// minimal rendering lives in the sibling `atelier-pager-minimal` crate; these
...
// `atelier-pager-render`. Re-exported at the crate root so existing
// `crate::<module>::...` references throughout the pager keep resolving.
pub use atelier_pager_render::{
