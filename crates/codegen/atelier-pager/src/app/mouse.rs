            ...
            MouseEventKind::Down(MouseButton::Left) => {
                    ...
                    && !self.pos_occluded(mouse.column, mouse.row)
                {
                    return InputOutcome::Action(Action::AnnouncementsOpenCta(
                        atelier_telemetry::events::AnnouncementCtaSurface::Banner,
                    ));
                }
                if self
                    .plugin_cta
                        ...
                        &self.plugin_cta.phase
                {
                    ...
                    if let Err(e) = atelier_shell::config::add_dismissed_plugin_cta(&plugin_id) {
                        tracing::warn!(
                    ...
                    atelier_telemetry::session_ctx::log_event(
                        atelier_telemetry::events::PluginCtaDismissed {
                ...
                {
                    return InputOutcome::Action(Action::AnnouncementsOpenCta(
                        atelier_telemetry::events::AnnouncementCtaSurface::Header,
                    ));
                }
