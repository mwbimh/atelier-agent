#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    /// and the shell emits the queue-emptying `atelier/queue/changed` right after
    ...
    /// `atelier/task_backgrounded` arriving after the skipped zero-work wait
    /// re-evaluates and restores the park.
    #[test]
    ...
    fn interjection_notification_pushes_block_to_matching_session() {
        ...
        // the shell as atelier/session/interjection; EVERY attached pane (incl.
