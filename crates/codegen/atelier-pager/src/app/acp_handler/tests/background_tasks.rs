#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn ext_session_update_replay_restores_bg_task() {
        ...
        let update = ExtensionSessionUpdate::TaskBackgrounded {
        ...
        handle(
            make_ext_session_notification_with_method("sess-1", "atelier/session/update", update),
            &mut app,
        );
    ...
    fn task_backgrounded_with_wire_description_still_drains_deferred_tool() {
        ...
        let notif = acp::ExtNotification::new("atelier/task_backgrounded", raw.into());
