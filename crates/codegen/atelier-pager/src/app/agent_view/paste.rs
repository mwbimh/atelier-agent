...
pub(super) mod paste_key_tests {
    ...
    -> crate::views::question_view::QuestionViewState {
        let question =
            atelier_tools::implementations::atelier_build::ask_user_question::Question {
                question: "Pick one?".to_string(),
                options: vec![
                atelier_tools::implementations::atelier_build::ask_user_question::QuestionOption
