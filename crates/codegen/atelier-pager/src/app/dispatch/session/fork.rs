...
-> [atelier_tools::implementations::atelier_build::ask_user_question::QuestionOption; 2] {
    use atelier_tools::implementations::atelier_build::ask_user_question::QuestionOption;
    [
        QuestionOption {
