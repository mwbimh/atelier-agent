...
//! (SuperAtelier Heavy). Instead of offering "Upgrade tier" + PAYG / buy-credits
...
mod tests {
    ...
    fn output_payg_off_mentions_enabling() {
        ...
        assert!(all_text.contains("atelier.invalid?_s=usage"));
    }
    ...
    fn output_structure_and_content() {
        let url = "https://atelier.invalid?_s=usage";
