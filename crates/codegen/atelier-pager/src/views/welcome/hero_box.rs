...
const HERO_SUBTITLE: &str = "A private, local-first coding agent. Configure a Provider to begin.";
...
pub(super) fn compute_hero_box(
    ...
    announcement: Option<&atelier_announcements::RemoteAnnouncement>,
    expanded: bool,
...
managed devices and accounts. Report security incidents";
    ...
    fn upgrade_cta_reserves_rows_and_returns_button_rect() {
        ...
        let a = ann(None, Some("Atelier 4.5 is here. Upgrade now."));
        ...
        let mut pinned = ann(None, Some("Atelier 4.5 is here. Upgrade now."));
        pinned.dismissible = Some(false);
        pinned.cta = Some(atelier_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://atelier/atelier".into()),
        ...
        let mut dismissible = ann(None, Some("Atelier 4.5 is here. Upgrade now."));
        dismissible.cta = Some(atelier_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://atelier/atelier".into()),
            caption: Some("or use Ctrl+O".into()),
        });
