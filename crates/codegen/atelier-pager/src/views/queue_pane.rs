...
pub enum QueueRowOrigin {
    ...
    /// while running). Edits route to the agent as `atelier/queue/*`.
    Server,
}
...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. AtelierNight's dark band leaking into AtelierDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default AtelierNight, dark) after the user switches —
        // painting a dark band on a light AtelierDay canvas.
