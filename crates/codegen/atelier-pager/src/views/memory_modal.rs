...
pub fn build_entries(
    files: Vec<atelier_shell::extensions::notification::MemoryFileInfo>,
) -> Vec<MemoryFileEntry> {
...
mod tests {
    ...
    fn file_label_extracts_filename() {
        assert_eq!(
            file_label("/home/user/.atelier/memory/MEMORY.md"),
            "MEMORY.md"
        );
        assert_eq!(
            file_label("/workspace/.atelier/memory/sessions/2026-01-15-fix-bug.md"),
    ...
    fn build_entries_groups_by_source() {
        use atelier_shell::extensions::notification::MemoryFileInfo;
