...
const THEME_CHOICES: &[EnumChoice] = &[
    ...
    EnumChoice {
        canonical: "ateliernight",
        display: "Atelier Night",
        description: "Neutral dark with magenta accent.",
    },
    EnumChoice {
        canonical: "atelierday",
        display: "Atelier Day",
...
const SCREEN_MODE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        ...
        display: "Fullscreen",
        description: "Open plain atelier in the standard fullscreen TUI. Default when unset.",
    },
    EnumChoice {
        canonical: "minimal",
        display: "Minimal",
        description: "Open plain atelier in scrollback-native (minimal) mode.",
    },
];
...
//
// Concrete codes must match `atelier_voice::STT_LANGUAGES` (official Atelier STT
// catalog — https://docs.atelier/developers/model-capabilities/audio/speech-to-text).
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            description: "How plain atelier opens next time: Fullscreen (default when unset) or \
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` resolved to "ateliernight".
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "ateliernight".
                default: "ateliernight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "atelierday".
                default: "atelierday",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
        ...
        // The `ATELIER_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        // follows the process locale when it maps to a Atelier STT language.
        // Catalog = official STT languages (see atelier_voice::STT_LANGUAGES).
        SettingMeta {
            key: "voice_stt_language",
            category: SettingCategory::Editor,
            owner: SettingOwner::Shell,
            label: "Voice language",
            description: "Speech-to-text language for voice dictation (Atelier STT). \
