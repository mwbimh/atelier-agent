...
//!
//! ```text
//! cargo bench -p atelier-pager --bench edit_highlight
//! cargo bench -p atelier-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use atelier_pager::diff::{DiffHunk, DiffLine};
use atelier_pager::scrollback::blocks::tool::{
...
use atelier_pager::syntax::{Syntect, get_syntect};
