//! Criterion benchmarks for the atelier-pager rendering pipeline.
//!
...
use atelier_pager::scrollback::render::render_scrolled_entries_with_scratch;
use atelier_pager::scrollback::wrappers::EntryRenderer;
use atelier_pager::scrollback::{
