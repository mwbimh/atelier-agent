...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "atelier-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "atelier-3", "researcher");
    ...
    let shared_models = ["atelier-3", "atelier-3-mini"];
