...
Terminal UI (TUI) for Atelier. Provides the interactive full-screen interface
...
- [Hook Examples](../atelier-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`atelier-hooks`)](../atelier-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`atelier-plugin-marketplace`)](../atelier-plugin-marketplace/) — marketplace source loading, scanning, and install
