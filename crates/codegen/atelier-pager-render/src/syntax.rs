...
//! Dark themes (AtelierNight, TokyoNight) share `atelier-night.tmTheme`;
//! AtelierDay uses `atelier-day.tmTheme` with deepened colors for light backgrounds.

use std::sync::OnceLock;

pub use atelier_markdown::Syntect;

use crate::theme::ThemeKind;

static SYNTECT_ATELIERNIGHT: OnceLock<Syntect> = OnceLock::new();
static SYNTECT_TOKYONIGHT: OnceLock<Syntect> = OnceLock::new();
static SYNTECT_ATELIERDAY: OnceLock<Syntect> = OnceLock::new();
...
pub fn get_syntect() -> &'static Syntect {
    match crate::theme::Theme::current_kind() {
        ...
        | ThemeKind::Auto => SYNTECT_ATELIERNIGHT
            .get_or_init(|| Syntect::new(include_bytes!("../assets/atelier-night.tmTheme"))),
        ThemeKind::TokyoNight => SYNTECT_TOKYONIGHT
            .get_or_init(|| Syntect::new(include_bytes!("../assets/tokyo-night.tmTheme"))),
        ThemeKind::AtelierDay => SYNTECT_ATELIERDAY
            .get_or_init(|| Syntect::new(include_bytes!("../assets/atelier-day.tmTheme"))),
    }
}
