...
//!
//! In dev mode, watches ~/.atelier/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.atelier/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.atelier/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = atelier_config::user_atelier_home()
