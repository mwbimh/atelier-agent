...
///
/// - `osc52_sink`: when `atelier wrap` is capturing this process's output (see
...
mod tests {
    ...
    // `atelier wrap` sink: a brand that does NOT natively support OSC 52 (the
    ...
    // container override is deliberately narrow; `atelier wrap` is the SSH path.
    #[test]
