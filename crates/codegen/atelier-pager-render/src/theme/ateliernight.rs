//! AtelierNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// AtelierNight palette — neutral gray base + TokyoNight accent colors.
//
