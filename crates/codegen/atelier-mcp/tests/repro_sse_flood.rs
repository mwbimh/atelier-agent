...
//!
//! Run with: cargo test -p atelier-mcp --test repro_sse_flood -- --nocapture
...
use atelier_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use atelier_mcp::rmcp::ServiceExt;
use atelier_mcp::rmcp::transport::StreamableHttpClientTransport;
use atelier_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
