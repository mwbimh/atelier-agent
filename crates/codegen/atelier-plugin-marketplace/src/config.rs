//! Parse marketplace sources from `~/.atelier/config.toml`.
//!
//! Expected format:
//! ```toml
//! [[marketplace.sources]]
...
/// instead of `~/.atelier`/`~/.claude`. Each root is checked for
