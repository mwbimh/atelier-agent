//! Public event types — the wire contract for `atelier-fsnotify`.
//!
...
//! translator (in `atelier-workspace`) maps these to
...
/// Aligned with `atelier_workspace_types::FsEventKind` (identity map at
