...
//! cargo run --release -p atelier-fsnotify --example watch_stats -- gen js /tmp/js-repo
//! ATELIER_FSNOTIFY_PER_DIR=0 cargo run --release -p atelier-fsnotify --example watch_stats -- run /tmp/js-repo 5
//! ATELIER_FSNOTIFY_PER_DIR=1 cargo run --release -p atelier-fsnotify --example watch_stats -- run /tmp/js-repo 5
//! ```
//!
...
use atelier_fsnotify::{FsConfig, FsEventSource};
