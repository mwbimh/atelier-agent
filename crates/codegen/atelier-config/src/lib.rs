//! Config file loading for Atelier.
//!
//! Merge order (lowest → highest priority):
//! 1. `/etc/atelier/managed_config.toml`
//! 2. `$ATELIER_HOME/managed_config.toml`
//! 3. `$ATELIER_HOME/config.toml`
//! 4. `$ATELIER_HOME/requirements.toml` (cloud cache; Ed25519-signed at rest once a
//!    key is embedded — see [`signed_policy`] — below the OS-protected layers)
//! 5. `/etc/atelier/requirements.toml`
//! 6. macOS MDM managed preferences (`ai.x.atelier`, admin-forced) — macOS only
//!
...
pub use paths::{
    atelier_application, atelier_home, claude_managed_settings_path,
    claude_managed_settings_probe_path, decode_cwd_from_dirname, default_atelier_home,
