...
use atelier_sampler::SamplingClient;
...
/// ambient shell exports (`ATELIER_SAMPLER_SHARED_CLIENT=0`,
/// `ATELIER_POOL_MAX_IDLE=0`) cannot flip the expected pooling behavior.
fn pin_env() {
    ...
    PIN.call_once(|| {
        ...
        unsafe {
            std::env::remove_var("ATELIER_SAMPLER_SHARED_CLIENT");
