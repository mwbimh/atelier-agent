...
if let Some(r) = atelier_crash_handler::check_previous_crash(&crash_dir) {
...
atelier_crash_handler::install(atelier_crash_handler::CrashHandlerConfig {
