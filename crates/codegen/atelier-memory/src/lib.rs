...
//! Atelier to persist important information across sessions. Memory files are
//! stored under `~/.atelier/memory/` with workspace-scoped subdirectories
...
//! `ATELIER_MEMORY=1` environment variable. When disabled, this crate
