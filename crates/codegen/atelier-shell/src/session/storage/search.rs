...
//! other concurrently running atelier processes (which may wipe or downgrade
...
/// User-configurable overrides via `~/.atelier/settings.json` are deferred
/// to a follow-up.
...
///
/// TODO: When multiple atelier processes run concurrently, they each have
