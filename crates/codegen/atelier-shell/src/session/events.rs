...
) -> Option<atelier_sampling_types::PriorTurnInterrupt> {
    use atelier_sampling_types::PriorTurnInterrupt;
    match category {
...
/// committing it would silently run atelier-build flavor. Distinct from
