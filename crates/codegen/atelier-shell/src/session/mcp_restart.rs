...
//! window containing a [`atelier_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`atelier_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`atelier_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`atelier_mcp::servers::ClientStateKind::Empty`]
...
use atelier_mcp::servers::{McpClientEventKind, McpServerName};
...
pub trait RestartActions {
    ...
    /// Push an already-built `atelier/mcp/server_status` payload to the
...
/// ACP `atelier/mcp/server_status` notification. Failures are logged and
