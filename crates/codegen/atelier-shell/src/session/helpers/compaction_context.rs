...
//! [`atelier_compaction::reminder`] so atelier-chat and atelier-build stay in lockstep.
...
pub fn to_system_reminder_sync(
    ...
    skills: &[atelier_tools::implementations::skills::types::SkillInfo],
...
pub async fn to_system_reminder(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[atelier_tools::implementations::skills::types::SkillInfo],
    memory_backend: Option<&dyn atelier_tools::types::memory_backend::MemoryBackend>,
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
) -> Option<String> {
...
fn to_system_reminder_inner(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[atelier_tools::implementations::skills::types::SkillInfo],
    memory_results: &[atelier_tools::types::memory_backend::MemorySearchResult],
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
) -> Option<String> {
    ...
    if let Some(listing) =
        atelier_tools::types::skill_discovery_tracker::format_compaction_skill_listing(skills)
    {
    ...
    if !ctx.connected_mcp_servers.is_empty() {
        use atelier_tools::implementations::search_tool::format_compaction_server_line;
