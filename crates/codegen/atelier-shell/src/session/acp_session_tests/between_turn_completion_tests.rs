use atelier_tools::implementations::atelier_build::task::types::SubagentCompletionSummary;
use atelier_tools::reminders::task_completion::format_between_turn_completions;
