...
fn usage_drain_outcome_policy_matches_freeze_and_cancel() {
    ...
    use atelier_tools::implementations::atelier_build::task::types::SubagentOutstandingReply;
...
> {
    use atelier_tools::implementations::atelier_build::task::types::SubagentEvent;
