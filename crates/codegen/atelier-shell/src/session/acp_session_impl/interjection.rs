...
/// `atelier/session/interjection` broadcast, so a live echo would duplicate it.
...
impl SessionActor {
    ...
    async fn interjection_skill_information(&self, text: &str) -> Option<String> {
        ...
        for sk in &parsed {
            ...
            atelier_telemetry::session_ctx::log_event(atelier_telemetry::events::SkillDispatched {
