...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<atelier_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(atelier_tools::implementations::atelier_build::update_goal::UpdateGoalInput),
    Channel(atelier_tools::implementations::atelier_build::update_goal::UpdateGoalEnvelope),
}
