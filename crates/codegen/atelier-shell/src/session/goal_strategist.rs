    ...
    async fn send_one(
        ...
        let request = SubagentRequest {
            ...
            runtime_overrides: SubagentRuntimeOverrides {
                fixed_role: Some(atelier_provider::RoleId::Strategist.as_str().to_owned()),
                model,
                harness_agent_type,
                ..Default::default()
            },
...
mod tests {
    ...
    /// parent (atelier-build) names, with no placeholder left behind. Guards
    ...
    fn strategist_template_renders_per_agent_type_names() {
        ...
        tool_names.insert(
            atelier_tools::types::tool::ToolKind::Execute,
            "alt_shell".to_string(),
        );
