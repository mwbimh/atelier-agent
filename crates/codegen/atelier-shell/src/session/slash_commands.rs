...
use atelier_tools::implementations::skills::skill::format_skill_name;
...
// ── atelier/commands/list ext method ────────────────────────────────
...
///   matching today's Atelier flow that calls our dedicated `skill` tool.
...
pub(super) async fn build_skill_information_for_refs(
    ...
    use atelier_tools::implementations::skills::skill::{
...
/// `atelier-tools` so it stays identical to the pager's `LoopCommand` and the
