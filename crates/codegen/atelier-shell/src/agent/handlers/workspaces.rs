...
mod tests {
    ...
    #[test]
    fn success_response_projects_atelier_workspace_fields() {
    ...
    fn degraded_response_carries_partial_reason() {
        ...
        assert_eq!(value["_meta"]["atelier/partial"]["workspaces"], true);
        assert_eq!(value["_meta"]["atelier/partial"]["reason"], "no_oauth");
    }
}
