...
//! two ways:
//!
//!   - request/response `atelier/sessions/list` → `{ "sessions": [RosterEntry, …] }`
//!   - broadcast notification `atelier/sessions/changed` →
...
/// Response payload for `atelier/sessions/list`.
#[derive(Serialize, Deserialize, Clone, Debug, Default)]
pub struct RosterListResponse {
    pub sessions: Vec<RosterEntry>,
}

/// Params payload for the `atelier/sessions/changed` broadcast notification.
#[derive(Serialize, Deserialize, Clone, Debug, Default)]
...
pub const SESSIONS_LIST_METHOD: &str = "atelier/sessions/list";
pub const SESSIONS_CHANGED_METHOD: &str = "atelier/sessions/changed";
