        ...
        .run_until(async {
            ...
            let (permission_handle, _events_rx) =
                atelier_workspace::permission::spawn_permission_manager(
                    ...
                    gateway,
                    cwd,
                    atelier_workspace::permission::types::ClientType::Generic,
            ...
            for access in [
                atelier_workspace::permission::AccessKind::Read(Some(".env".into())),
                atelier_workspace::permission::AccessKind::Bash("cat .env".into()),
            ] {
                ...
                assert!(
                    matches!(
                        decision,
                        atelier_workspace::permission::Decision::PolicyDeny(_)
                    ),
