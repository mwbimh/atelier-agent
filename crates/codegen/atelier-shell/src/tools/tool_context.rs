...
//! atelier-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn atelier_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<atelier_tools::implementations::atelier_build::task::types::MonitorEventBuffer>,
...
impl ToolContext {
    pub fn new(
        ...
        let session_env = atelier_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
