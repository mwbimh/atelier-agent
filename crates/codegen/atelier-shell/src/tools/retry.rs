//! Retry utilities — re-exported from `atelier-tools`.
//!
//! The canonical implementation now lives in `atelier_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use atelier_tools::retry::BackoffConfig as RetryConfig;
pub use atelier_tools::retry::{BackoffConfig, execute_with_backoff};
