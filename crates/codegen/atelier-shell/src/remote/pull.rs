...
pub(crate) mod hydrate {
    ...
    fn write_summary(
        ...
        let summary = Summary {
            ...
            head_branch: None,
            request_id: None,
            // Record the *local* atelier_home (where this hydrated copy lives),
            ...
            sandbox_profile: atelier_sandbox::configured_profile_name().map(String::from),
    ...
    const REPLAYABLE_METHODS: &[&str] = &["session/update", "_atelier/session/update"];
