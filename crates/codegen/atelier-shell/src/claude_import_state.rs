...
//
// State is persisted to `~/.atelier/claude_import_state.json`.
...
use atelier_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.atelier/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::atelier_home::atelier_home().join("claude_import_state.json")
}
