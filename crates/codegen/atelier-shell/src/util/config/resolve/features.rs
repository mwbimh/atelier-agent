...
pub fn resolve_zdr_access_enabled(
    ...
    BoolFlag::env("ATELIER_ZDR_ACCESS_ENABLED")
...
pub fn resolve_remote_fetch_enabled() -> bool {
    ...
    // remote value may re-enable the vendor model/settings fetch pipeline.
    tracing::debug!("remote model/settings fetch is permanently disabled");
    false
}
...
mod tests {
    ...
    #[test]
    fn runtime_remote_fetch_is_hard_disabled() {
