...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "ATELIER_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "ATELIER_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`ATELIER_MIN_DRAW_MS` / `ATELIER_SCROLL_CADENCE_MS`).
