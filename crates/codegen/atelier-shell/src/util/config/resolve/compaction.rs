...
pub(crate) const ENV_AUTO_COMPACT_THRESHOLD_PERCENT: &str =
    "ATELIER_AUTO_COMPACT_THRESHOLD_PERCENT";
...
///   1. env `ATELIER_AUTO_COMPACT_THRESHOLD_PERCENT`
...
const ENV_COMPACTION_WALL_CLOCK_BUDGET_SECS: &str = "ATELIER_COMPACTION_WALL_CLOCK_SECS";
...
mod compaction_wall_clock_budget_tests {
    ...
    // Assumes ATELIER_COMPACTION_WALL_CLOCK_SECS is unset in the test env.
    #[test]
