...
pub(crate) const ENV_REMEMBER_TOOL_APPROVALS: &str = "ATELIER_REMEMBER_TOOL_APPROVALS";
...
/// shown. Precedence: requirements > env (`ATELIER_REMEMBER_TOOL_APPROVALS`) >
...
mod remember_tool_approvals_gate_tests {
    ...
    // `ATELIER_REMEMBER_TOOL_APPROVALS` is process-global; serialize and force it
