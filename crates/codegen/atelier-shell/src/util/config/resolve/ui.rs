...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "ATELIER_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`ATELIER_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "ATELIER_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`ATELIER_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "ATELIER_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`ATELIER_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `ATELIER_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("ATELIER_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes ATELIER_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
