...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        parent_skills: None,
        parent_skills_config: atelier_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: atelier_tools::types::compat::CompatConfig::default(),
        auto_wake_delivered: None,
        synthetic_trace_tx: None,
        task_output_tool_name: atelier_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl atelier_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &atelier_tools::implementations::lsp::LspToolInput,
    ) -> atelier_tools::implementations::lsp::LspToolResult {
        atelier_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<atelier_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<atelier_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
