//! `atelier/plugins/*` extension handlers.
//!
...
pub fn loaded_plugin_to_info(plugin: &atelier_agent::plugins::LoadedPlugin) -> PluginInfo {
    use atelier_agent::plugins::discovery::PluginScope as AgentScope;
...
fn origin_to_dto(origin: &atelier_agent::plugins::PluginOrigin) -> PluginOrigin {
    use atelier_agent::plugins::PluginOrigin as AgentOrigin;
    match origin {
        AgentOrigin::CliOverride => PluginOrigin::CliOverride,
        AgentOrigin::ProjectAtelier => PluginOrigin::ProjectAtelier,
        AgentOrigin::ProjectClaude => PluginOrigin::ProjectClaude,
        AgentOrigin::UserAtelier => PluginOrigin::UserAtelier,
...
mod tests {
    use super::*;
    use atelier_agent::plugins::PluginOrigin as AgentOrigin;
    use atelier_agent::plugins::discovery::{PluginId, PluginScope as AgentScope};

    fn make_loaded_plugin(origin: AgentOrigin) -> atelier_agent::plugins::LoadedPlugin {
        let root = std::path::PathBuf::from("/tmp/test-plugin");
        atelier_agent::plugins::LoadedPlugin {
