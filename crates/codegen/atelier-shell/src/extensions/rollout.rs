//! `atelier/rollout/survey` extension handler.
//!
...
use atelier_telemetry::events::RolloutSurvey;
use atelier_telemetry::session_ctx::log_event;

#[tracing::instrument(skip_all, fields(method = %args.method))]
pub async fn handle(_agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    let _ = args;
    return Err(acp::Error::invalid_params().data("Rollout surveys are disabled in Atelier."));
