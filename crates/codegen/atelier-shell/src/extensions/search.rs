...
use atelier_workspace::file_system::ContentSearchRequest as ContentSearchRequestParams;
use atelier_workspace::workspace_ops::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
...
pub async fn handle(agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    match args.method.as_ref() {
        ...
        "atelier/search/content" => {
            ...
            // `atelier/search/content/status` batches through the client sink.
