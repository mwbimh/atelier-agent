...
//! This module re-exports them and adds atelier-shell-specific types
...
// ============================================================================
// atelier-shell-specific types (depend on internal crate types)
// ============================================================================

/// Tracing context for conversation requests.
///
/// Stays in `atelier-shell` because it references
