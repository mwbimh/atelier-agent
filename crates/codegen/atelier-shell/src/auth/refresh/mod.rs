...
pub(crate) trait ExternalCommandRunner: Send + Sync {
    ...
    fn run_external_command(&self, command: &str) -> Option<AtelierAuth>;
}
...
impl RefreshOutcome {
    ...
    pub(crate) fn success(auth: AtelierAuth) -> Self {
...
mod tests {
    use super::*;
    use crate::auth::{AtelierAuth, AtelierComConfig, AuthMode};
