...
use super::super::AtelierAuth;
use super::protocol::{OidcError, OidcUserInfo, build_atelier_auth, discover, refresh_tokens};
...
pub(crate) async fn oidc_token_exchange(auth: &AtelierAuth) -> OidcRefreshResult {
    ...
    let mut new_auth = build_atelier_auth(tokens, user_info, issuer, client_id);
