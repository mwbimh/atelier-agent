...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&AtelierAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> atelier_telemetry::events::AuthTokenKind {
        use atelier_telemetry::events::AuthTokenKind as K;
        match self {
