...
//! (SuperAtelier, SuperAtelier Heavy/Lite, X Premium/+, and any unknown future name)
...
mod tests {
    ...
    fn unrestricted_names() {
        assert!(!is_restricted_tier_name("SuperAtelier"));
        assert!(!is_restricted_tier_name("SuperAtelier Heavy"));
        assert!(!is_restricted_tier_name("superatelier_lite"));
