//! Shared helpers for atelier-shell integration tests.

use atelier_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `atelier_sampler::SamplingClient`, which takes a
