...
//! binary shares one process-global `ATELIER_HOME`, process env, and key override.
...
pub fn signed_team_body(
    ...
    let payload = SignedPayload {
        ...
        fail_closed: requirements.is_some_and(atelier_config::fail_closed_flag_from_str),
...
pub fn team_identity(id: &str) -> atelier_shell::config::ServingIdentity {
    atelier_shell::config::ServingIdentity::Team(id.to_owned())
}
