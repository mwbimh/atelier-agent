//! Atelier Speech-to-Text language codes.
//!
//! Source of truth for the `language` query/form parameter on
//! `https://api.atelier/v1/stt` and `wss://api.atelier/v1/stt`.
//!
//! Official catalog (25 languages):
//! <https://docs.atelier/developers/model-capabilities/audio/speech-to-text#supported-languages>
//!
...
/// Official Atelier STT languages (docs.x.ai), sorted by English name.
///
