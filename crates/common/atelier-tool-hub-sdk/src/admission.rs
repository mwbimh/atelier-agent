...
/// Numeric JSON-RPC code for overload rejection (`atelier-tool-protocol`
...
const GLOBAL_MAX_INFLIGHT_ENV: &str = "ATELIER_TOOL_SERVER_GLOBAL_MAX_INFLIGHT";
...
/// `ATELIER_TOOL_SERVER_GLOBAL_MAX_INFLIGHT` when present and parseable as a
...
mod tests {
    ...
    #[test]
    fn global_limit_environment_uses_atelier_namespace() {
        assert_eq!(
            GLOBAL_MAX_INFLIGHT_ENV,
            "ATELIER_TOOL_SERVER_GLOBAL_MAX_INFLIGHT"
        );
    }
