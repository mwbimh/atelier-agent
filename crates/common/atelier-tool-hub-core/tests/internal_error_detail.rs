...
use atelier_tool_hub_core::{error_from_envelope, tool_error_from_wire};
use atelier_tool_protocol::{JsonRpcError, RequestId, ToolErrorWire};
use atelier_tool_runtime::ToolErrorKind;
use serde_json::json;
