...
fn map_block(block: atelier_tool_protocol::McpBlock) -> ContentBlock {
    use atelier_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: atelier_tool_protocol::JsonRpcError) -> ToolError {
