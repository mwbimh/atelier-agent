...
//! string/text manipulation. Harness-bound extraction (Atelier chat's
//! `AtelierConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `AtelierMessage` assembly) stays in the harness crate.
