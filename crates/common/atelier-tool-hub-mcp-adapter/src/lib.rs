//! Unified MCP adapter for the Atelier Tool Hub.
//!
...
//! tools, and produces [`ToolServerHandler`](atelier_tool_hub_sdk::ToolServerHandler)
//! implementations that can be registered with a hub
//! [`ToolServerBuilder`](atelier_tool_hub_sdk::ToolServerBuilder).
//!
//! # Architecture
//!
//! ```text
